...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { author_id: @follow.author_id, entity_id: @follow.entity_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { author_id: @follow.author_id, entity_id: @follow.entity_id } }
